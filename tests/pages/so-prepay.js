...
export class SoPrePayPage extends AcumaticaBasePage {
  constructor(page) {
  ...
  async createSoPrePay(frame, data) {
  ...
  async workflowbutton(frame) {
    ...
    await expect(frame.locator('#ctl00_phF_form_t0_edStatus')).toHaveText('Awaiting Payment')
  }
}